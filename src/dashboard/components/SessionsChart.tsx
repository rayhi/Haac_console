  ...
  return (
    ...
    >
      <CardContent>
        ...
        >
          <AreaGradient color={theme.palette.primary.main} id="organic" />
          <AreaGradient color={theme.palette.warning.main} id="referral" />
          <AreaGradient color={theme.palette.primary.dark} id="direct" />
        </LineChart>
      </CardContent>
    </Card>
  );
